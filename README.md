...
- После команды auth, если все хорошо, бот должен написать, что Авторизация успешна.
- Далее можно запустить слежение за игрой: /game_monitor. Если игра уже началась, запросите задание /task. Если еще не началась, бот сам пришлет первое задание, как только игра начнется, если включен мониторинг.
- Протестировать бота можете на любой игре, доступной для прохождения или на тех. домене при наличии авторских прав
