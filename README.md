...
async версия с использованием VkBottle
...
- Скачать последнюю скомпилированную в exe версию из релизов (нужна win >=10): https://github.com/temig74/en_vk_bot/releases или запускать из исходников через питон, установив все необходимые библиотеки (Vkbottle, selenium, BeautifulSoup4, lxml), использовалась версия питона 3.12
